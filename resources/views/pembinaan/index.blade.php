...
@section('title')
<h2>PEMBINAAN PENGELOLAAN KEUANGAN DESA
    <div class="pull-right">
        ...
        <a href="{{ route('pembinaan.create')}}" class="btn btn-xs btn-primary"><i class="material-icons">note_add</i> Tambah</a>
    </div>
</h2>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="tagForm" id="tag-form" action="{{ route('pembinaan.upload') }}" method="post" enctype="multipart/form-data">
                @csrf
