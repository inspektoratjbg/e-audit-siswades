...
<div class="card ">
    ...
    <tr>
        <td align="center" colspan="3"><b>INSPEKTORAT KABUPATEN JOMBANG <br>Jln. Gatot Subroto No. 169 Jombang </b></td>
    </tr>
</table> -->
...
<table cellspacing="0" cellpadding="0" width="100%" style="font-size:12px">
    <tr>
        <td colspan="3">Nama Auditan : {{ $desa->Nama_Desa }}</td>
    ...
    <tr>
        <td colspan="3">Periode yg. Diaudit : {{ date('Y') }}</td>
    ...
    <tr>
        <td colspan="7" style=" border-bottom:1pt solid black; " align="center">Kertas Kerja Audit			</td>
    </tr>
    <tr>
        <td></td>
    </tr>
...
<br>
<table cellspacing="0" cellpadding="0" style="font-size:14px" border="1">
    <tr>
        <td width="10px">I</td>
