...
<h2>PEMBINAAN & Evaluasi
    <div class="pull-right">
        ...
        <a href="{{ route('pembinaanevaluasi.create')}}" class="btn btn-xs btn-primary"><i class="material-icons">note_add</i> Tambah</a>
    </div>
</h2>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="tagForm" id="tag-form" action="{{ route('pembinaanevaluasi.upload') }}" method="post" enctype="multipart/form-data">
                @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#tag-form-submit').on('click', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('pembinaanevaluasi.upload') }}",
                data: data,
                processData: false,
                contentType: false,
