                ...
                <form action="{{ $data['action'] }}" id="form_validation" method="POST">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{  $errors->has('tahun')?'error':'' }}">
                            <input type="text" name="tahun" id="tahun" class="form-control" required value="{{ $data['res']->tahun??old('tahun')??date('Y') }}">
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ url('pengaduan') }}" class="btn btn-warning"><i class="material-icons">flip_to_back</i> Kembali</a>
                    </div>
                </form>
            </div>
        </div>
